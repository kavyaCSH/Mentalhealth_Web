    ...
    return (
        <div className="flex flex-col h-full">
            <div className="mb-6">
                ...
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-1 px-1">Patient History Archive</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide pb-20">
                {loading ? (
                    ...
                    <div className="text-center py-16 border-2 border-dashed border-white/5 rounded-3xl">
                        ...
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">No matching records</p>
                    </div>
                ) : (
                    <div className="space-y-3">
                        {history.map((entry, idx) => (
                            <div key={idx} className="bg-white p-4 rounded-xl border-2 border-slate-200 hover:border-indigo-500 shadow-sm transition-all group">
                                <div className="flex items-center justify-between mb-3 px-1">
                                    <span className="text-[9px] font-black text-indigo-600 uppercase tracking-widest bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-100">
                                        Chief Complaint
                                    </span>
                                    <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest tabular-nums">
