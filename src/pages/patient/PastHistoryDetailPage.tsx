...
const PastHistoryDetailPage = () => {
    ...
    const categories = [
        ...
        { label: 'Trauma & Resilience', value: traumaData?.significant_losses || traumaData?.physical_abuse, icon: <Shield size={24} />, color: 'text-violet-600', bg: 'bg-violet-50', border: 'border-violet-100' }
    ];
